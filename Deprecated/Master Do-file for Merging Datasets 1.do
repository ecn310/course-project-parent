...
replace statefips = 1  if name == "AL"
replace statefips = 2  if name == "AK"
replace statefips = 4  if name == "AZ"
replace statefips = 5  if name == "AR"
replace statefips = 6  if name == "CA"
replace statefips = 8  if name == "CO"
replace statefips = 9  if name == "CT"
replace statefips = 10 if name == "DE"
replace statefips = 11 if name == "DC"
replace statefips = 12 if name == "FL"
replace statefips = 13 if name == "GA"
replace statefips = 15 if name == "HI"
replace statefips = 16 if name == "ID"
replace statefips = 17 if name == "IL"
replace statefips = 18 if name == "IN"
replace statefips = 19 if name == "IA"
replace statefips = 20 if name == "KS"
replace statefips = 21 if name == "KY"
replace statefips = 22 if name == "LA"
replace statefips = 23 if name == "ME"
replace statefips = 24 if name == "MD"
replace statefips = 25 if name == "MA"
replace statefips = 26 if name == "MI"
replace statefips = 27 if name == "MN"
replace statefips = 28 if name == "MS"
replace statefips = 29 if name == "MO"
replace statefips = 30 if name == "MT"
replace statefips = 31 if name == "NE"
replace statefips = 32 if name == "NV"
replace statefips = 33 if name == "NH"
replace statefips = 34 if name == "NJ"
replace statefips = 35 if name == "NM"
replace statefips = 36 if name == "NY"
replace statefips = 37 if name == "NC"
replace statefips = 38 if name == "ND"
replace statefips = 39 if name == "OH"
replace statefips = 40 if name == "OK"
replace statefips = 41 if name == "OR"
replace statefips = 42 if name == "PA"
replace statefips = 44 if name == "RI"
replace statefips = 45 if name == "SC"
replace statefips = 46 if name == "SD"
replace statefips = 47 if name == "TN"
replace statefips = 48 if name == "TX"
replace statefips = 49 if name == "UT"
replace statefips = 50 if name == "VT"
replace statefips = 51 if name == "VA"
replace statefips = 53 if name == "WA"
replace statefips = 54 if name == "WV"
replace statefips = 55 if name == "WI"
replace statefips = 56 if name == "WY"
