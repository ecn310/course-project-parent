...
\begin{figure}[htbp]
    ...
    \caption{Intergenerational Mobility Vs. Average Time spent on childcare}
...
\noindent AI disclosure: Generative AI was not used in the completion of any of the work of the results section. 
