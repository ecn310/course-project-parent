...
use "Data\Merge\Merged,Weighted,Labeled.dta" 
...
replace state_abbrev = "DC" if statefips == 11
...
scatter trthh perm25_popw , mlabel( state_abbrev) title("Parental Investment vs Intergenerational Mobility") xtitle("Income Rank at Age 24 born in 25%") ytitle("Parental Investment (minutes)  ") xscale(range(20 60))

** Save the graph as png (or any preferred type)
graph export "Outputs\25novar.png", as(png) name("Graph") replace
...
scatter trthh perm75_popw , mlabel( state_abbrev) title("Parental Investment vs Intergenerational Mobility") xtitle("Income Rank at Age 24 born in 75%") ytitle("Parental Investment (minutes) ") xscale(range(20 60))
...
scatter trthh medianinc , mlabel( state_abbrev) title("Parental Investment vs Average Income By State") xtitle("Average Median Income Per State") ytitle("Parental Investment (minutes) ")
