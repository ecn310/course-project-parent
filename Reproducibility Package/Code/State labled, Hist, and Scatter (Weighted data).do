...
graph export "Outputs\Income Rank at Age 24 (25th Percentile) (weighed) graph.png", as(png) name("Graph")

** To make hist for the varible perm75_popw **
hist perm75_popw , frequency xtitle("Income Rank at Age 24 (75th Percentile)")
graph export "Outputs\Income Rank at Age 24 (75th Percentile)(weighed) graph.png", as(png) name("Graph")
...
graph export "Outputs\25novar.png", as(png) name("Graph")
