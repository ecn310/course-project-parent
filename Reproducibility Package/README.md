...
- First, create a folder on your device labeled "Parent", then within it create 3 subfolders, **Code, Data, and Outputs**, where all data and do-files will be saved once downloaded, and the outputs will be saved to omce created. 
