...
- First, create a folder on your device labeled “Parent”. Then, within it, create three subfolders: **Code, Data, and Outputs**.  All data and do-files will be saved here once downloaded, and the outputs will be saved here once created. Also in the **Data** folder create another subfolder labeled **Merge** where all data files once cleanded and merged will live. Or you can sync our GitHub to your own local GitHub desktop and accesse the Data, Code, and Outputs there. 
