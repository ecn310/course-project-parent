...
• We, the team named <ins>**Parents**</ins> agree with the information documented in our team charter, and will try out best to uphold this charter. By signing below, we indicate our commitment to our team. The group is expected to demonstrate positive cohesive teamwork while developing and presenting this assignment. All members of the group are to make equal efforts for the success of the group research question. All group members are to fulfill the responsibilities of completing the assignment and making strong efforts for success related to group role expectations.

<details>
  
***<summary>For the duration of this project, I (the student) will participate effectively in this group and strive to do the following;</summary>***
...
Divorce Clause:
• Each group member will hold each other accountable in meeting their individual obligation, and may warn the member(s) of poor contributions. When a group member(s) continuously causes group dysfunction, the other group members and the offending member(s) must meet with the professor. When a group member(s) chooses not to meet the minimum expectations of positive group cohesion, that member(s) will receive a grade of 0 (zero) for the group research project and could be removed from the group (at the discretion of the professor). The professor has the final decision making responsibility for group divorce.
