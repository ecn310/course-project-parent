...
\begin{itemize}
  ...
  \item What is the coverage of the data?  3224 counties throughout the United States
    \begin{itemize}
        ...
        \item What kind of observations (countries? individual survey respondents? etc) Average income of child born in 1978 with parents in the 1, 25, 50, etc income percentile per county
...
\begin{itemize}
    \item Compiled all the Opportunity Atlas income data from 2019 into excel and onto stata. Organised ATUS data and will begin data analysis soon. 
    \item Need to clean and break down excel data on stata and perform regression analysis. 
\end{itemize}
