...
The Opportunity Atlas is a compilation of 3 different data sets ( Decennial Census, Federal income tax returns, and the American Community Surveys). The data uses \textbf{3224} counties across the U.S. and children's outcomes in adulthood within them. The American Time Use survey comes from randomly selected households ( Specifically Married Parents) who have taken part in the Current Population and breaks down how tye spend their day. 

\subsection{Data Set 1 (The Opportunity Atlas)}
\begin{itemize}
  ...
  \item What is the coverage of the data?  3224 counties throughout the United States
    \begin{itemize}
        ...
        \item Scope (e.g., if countries, only developed countries?) All counties within the U.S.  
    \end{itemize}
